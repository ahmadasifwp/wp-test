jQuery( document ).on( 'ready fusion-element-render-fusion_faq', function( $, cid ) {
	var $elementCheck = 'undefined' !== typeof cid ? jQuery( 'div[data-cid="' + cid + '"]' ).find( '.fusion-faq-shortcode' ) : jQuery( '.fusion-faq-shortcode' );
	$elementCheck.each( function() {
		...
		$faqsElement.find( '.fusion-filters a' ).on( 'click', function( e ) {
