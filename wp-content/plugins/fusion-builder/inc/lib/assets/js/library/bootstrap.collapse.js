...
+function ($) {
	...
	var actives = this.$parent && this.$parent.find('> .fusion-panel > .in, > .fusion-panel > .fusion-builder-child-element-content > .in');
	...
	this.$element
		...
		.addClass('collapsing toggle-fadein')
		[dimension](0);
	...
	var complete = function () {
		this.$element
		.removeClass('collapsing toggle-fadein')
	...
	this.$element
		.addClass('collapsing toggle-fadeout')
		.removeClass('collapse')
		.removeClass('in');
	...
	var complete = function () {
		...
		.removeClass('collapsing toggle-fadeout')
		.addClass('collapse');
	};
